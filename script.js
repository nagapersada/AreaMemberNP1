...
// [DIPERBAIKI] Logika Motivasi Ambil dari Gap Growth 50%
function openBroadcastModal() {
    const total = document.getElementById('totalMembers').innerText;
    // Mengambil nilai dari kolom KURANG di bawah grafik (Target 50%)
