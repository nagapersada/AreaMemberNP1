...
function renderDashboard(){
    ...
    // REVISI: Menggunakan Math.floor (Pembulatan ke bawah) agar konsisten dengan modal
...
// ==========================================
// REVISI FUNGSI PIALA: PERIODE LALU & VIP SAJA
// Menggunakan Math.floor (Pembulatan ke bawah)
// ==========================================
function openAchieverModal() {
    const modal = document.getElementById('achieverModal'), body = document.getElementById('achieverBody'), title = document.getElementById('achieverTitle'),
