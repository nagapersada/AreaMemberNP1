...
function renderDashboard(){
    ...
    // LOGIKA PERIODE
    31===i?(l=new Date(k,j+1,1),m=new Date(k,j,30,23,59,59),n="PERIODE 1 (BLN DEPAN)"):i<=15?(l=new Date(k,j,1),m=new Date(k,j,15,23,59,59),n=`PERIODE 1 (${getMonthName(j)})`):(l=new Date(k,j,16),m=new Date(k,j+1,0,23,59,59),n=`PERIODE 2 (${getMonthName(j)})`,o=!0);
    
    document.getElementById('currentPeriodLabel').innerText=n;
    
    // START COUNTDOWN REALTIME
    startCountdown(m);
...
// =========================================
// LOGIKA COUNTDOWN REAL-TIME & IKONIK
// =========================================
let intervalId; 
